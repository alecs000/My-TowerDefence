    ...
    void SrartLevel(int level = -1)
    {
        ...
        switch (level)
        {
            ...
            case 2:
                ...
                break;
            case 3:
                waveShell = new int[] { 1, 1, 5, 1 ,2};
                waveSlime = new int[] { 2, 3, 5, 1 , 1};
                waveOrc = new int[] { 1, 2, 3, 1 ,0};
                waveSpider = new int[] { 1, 2, 2, 4 ,2};
                waveBug = new int[] { 0, 0, 0, 0, 0 };
                waveStoneMonster = new int[] { 0, 0, 0, 0, 0 };
                waveEyes = new int[] { 0, 0, 0, 0, 0 };
                boss = bossBug;
                break;
            case 4:
                waveShell = new int[] { 1, 1, 5, 1, 0, 1 };
                waveSlime = new int[] { 2, 3, 5, 0, 3, 2 };
                waveOrc = new int[] { 1, 2, 3, 1, 1, 3, 1 };
                waveSpider = new int[] { 1, 2, 2, 4, 0, 1 };
                waveBug = new int[] { 0, 3, 1, 0, 3, 2, 1 };
                waveStoneMonster = new int[] { 0, 0, 0, 0, 0, 0 };
                waveEyes = new int[] { 0, 0, 0, 0, 0, 0 };
                boss = bossStoneMonster;
                break;
            case 5:
                waveShell = new int[] { 0, 6, 0, 0, 0, 1 };
                waveSlime = new int[] { 2, 0, 0, 0, 0, 1 };
                waveOrc = new int[] { 1, 3, 3, 0, 0, 1 };
                waveSpider = new int[] { 1, 3, 0, 1, 0, 1 };
                waveBug = new int[] { 0, 2, 1, 3, 1, 1 };
                waveStoneMonster = new int[] { 2, 0, 0, 3, 2, 1 };
                waveEyes = new int[] { 0, 0, 0, 0, 0, 0 };
                boss = bossEyes;
                break;
            case 6:
                waveShell = new int[] { 0, 6, 0, 0, 0, 9, 0 };
                waveSlime = new int[] { 2, 0, 0, 0, 4, 0, 0 };
                waveOrc = new int[] { 1, 3, 3, 0, 2, 1, 2 };
                waveSpider = new int[] { 1, 3, 0, 1, 1, 3, 1 };
                waveBug = new int[] { 0, 2, 1, 3, 3, 2, 5 };
                waveStoneMonster = new int[] { 2, 0, 0, 3, 0, 2, 0 };
                waveEyes = new int[] { 2, 0, 0, 3, 1, 1, 1 };
                boss = bossEyes;
                break;
        }
    }

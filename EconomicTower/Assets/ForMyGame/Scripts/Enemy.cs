...
public class Enemy : IEnemy
{
    ...
    //в пуле enemy сперва активен а на не надо чтобы он при по€влении в пуле регестрировалс€ в основном списке мб не нужен
    bool TrF; 
    ...
    public IEnumerator WaidEnemyAtack()
    {
        ...
        while (targetAlly != null)
        {
            ...
            {
                Debug.Log("¬ражина"+targetAlly.livesAlly.lives);
    ...
    public void Moving()
    {
        ...
        //¬раги идут не по пр€мой а чучуть сворачивают мб ненужно
